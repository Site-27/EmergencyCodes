...
namespace EmergencyCodes
{
    public class Config : IConfig
    {
        ...
        [Description("What CASSIE will say when a code is activated, and the custom subtitles attached to that message.")]
        ...
        [Description("What CASSIE will say during the startup procedure, and the custom subtitles attached to that message.")]
        ...
        public string StartupSubtitles { get; set; } = "\n<color=#131313>[ START UP PROCEDURE HAS BEGUN ] . .\n<color=#2c2c2c>Turning on Backup Power Bank.\n<color=#1b3b19>Initializing Biological Scan.\n<color=#30492e>Installing Broadcast Information.\n<color=#4c5d4b>Commencing Activation of Doors and Elevators.\n<color=#768b74>Activating Facility Lights.\n<color=#ffffff>Welcome <color=#ffff00> [ FACILITY PERSONNEL ]. <color=#ffffff>There is an estimated amount of <color=#ffa500> [ {number} ] [ CLASSD PERSONNEL ] <color=#ffffff>. Testing has been confirmed on <color=#ff0000> [ {anomalies} ] . <color=#28ff13>Execute standard testing procedures. <color=#81ff74>Cooperate with safety.";


        [Description("What CASSIE will say during testing, and the custom subtitles attached to that message.")]
        public string TestingMessage { get; set; } = "$PITCH_0.15 .G3 .G3 $PITCH_0.90 ATTENTION . $PITCH_1 Testing on {anomalies} will now commence . Please go to <color=red> {room} for testing . Again . Please go to {room} immediately . Thank you .";
        public string TestingSubtitles { get; set; } = "<color=red>ATTENTION. <color=white>Testing on <color=red>[ {anomalies} ] <color=white>will now commence. Please go to <color=red>[ {room} ] <color=white>for testing. Again, please go to <color=red>[ {room} ] <color=white>immediately. Thank you.";
    }
}
